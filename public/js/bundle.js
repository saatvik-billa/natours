      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 7:
            ...
            (0, _alerts.showAlert)('error', _context.t0.response.data.message); // coming from axios documentation
    ...
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            res = _context2.sent;
            if (res.data.status === 'success') location.reload(true); // the 'true' will force a reload from the server and not the browser 
...
var stripe = Stripe('pk_test_51HCWahDqocneOHatFXNt6dtPfsGZK7OgInWlaV6yPZaoIgISVV9yxssn6NwcAoaMzkhVE0UDOiM2kz1TNgQjltAq00GU2XrMhd');
